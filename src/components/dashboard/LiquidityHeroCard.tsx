...
import { LiquidityDetailModal } from "./modals/LiquidityDetailModal";
...
export function LiquidityHeroCard({ 
  ...
  return (
    <>
      <article 
        className="glass-dark glow-accent relative h-80 overflow-hidden rounded-3xl shadow-dark cursor-pointer"
